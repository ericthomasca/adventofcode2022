...
fn main() -> Result<()> {
    ...
    let my_part_1_score = strategy_part_1(&rounds);
    let my_part_2_score = strategy_part_2(&rounds);

    println!("My first strategy score is {}", my_part_1_score);
    println!("My second strategy score is {}", my_part_2_score);
...
fn strategy_part_2(rounds: &Vec<&str>) -> i32 {
    let mut my_total_score = 0;
    for round in rounds {
        let hands: Vec<&str> = round.split(' ').collect();
        let opponent_hand = hands[0];
        ...
        if opponent_hand == opponent_rock && my_hand == my_lose {
            my_score += 3;
        } else if opponent_hand == opponent_rock && my_hand == my_draw {
            my_score += 4;
        } else if opponent_hand == opponent_rock && my_hand == my_win {
            my_score += 8;
        } else if opponent_hand == opponent_paper && my_hand == my_lose {
            my_score += 1;
        } else if opponent_hand == opponent_paper && my_hand == my_draw {
            my_score += 5;
        } else if opponent_hand == opponent_paper && my_hand == my_win {
            my_score += 9;
        } else if opponent_hand == opponent_scissors && my_hand == my_lose {
            my_score += 2;
        } else if opponent_hand == opponent_scissors && my_hand == my_draw {
            my_score += 6;
        } else if opponent_hand == opponent_scissors && my_hand == my_win {
            my_score += 7;
        } else {
            println!("Problem mathing hand")
        }
